...
<\body>
  ...
  The Trie consists of <version-both|3 three |2 >types of <version-both|node
  base on how they stores the subsequence of shared prefix nibbles:|nodes
  base:>
  ...
  <\itemize>
    ...
    <item><strong|<version-both|Extension:|Branch:>>
    <version-both|<version-suppressed>|It has at least 1 and up to 16
    children. >It stores <version-both|subsequence |the partial key shared by
    its children. It accounts for one nibble >of
    <version-both|KeyEncode(<math|k>) |the key corresponding to to the path
    passing through each >of <version-both|size larger than 1 (i.e. 4 bits)
    which at least shared with two or more keys in |its children by >the
    <version-both|Trie. It always has one |position it stores the >child. It
    <version-both|does not store |optionally stores >a
    <version-both|value.|value of the key corresponding to the path traversed
    to the node.>
  ...
  <\definition>
    ...
    <\equation*>
      <tabular|<tformat|<table|<row|<cell|NodeType>|<cell|:>|<cell|\<cal-N\>>|<cell|\<rightarrow\>>|<cell|<around*|{|<version-both|Leaf,Extension,Branch|Leaf,Branch>|}>>>|<row|<cell|>|<cell|>|<cell|N>|<cell|\<mapsto\>>|<cell|The
      type of node N>>>>>
    </equation*>
  </definition>
  ...
  node <math|j=0>.<version-both| |<version-suppressed>>
  ...
  <\definition>
    ...
    <\equation*>
      NodePrefix<around|(|N|)>\<assign\><around*|{|<tabular*|<version-both|<tformat|<cwith|1|-1|1|1|cell-halign|l>|<cwith|1|-1|1|1|cell-lborder|0ln>|<cwith|1|-1|2|2|cell-halign|l>|<cwith|1|-1|3|3|cell-halign|l>|<cwith|1|-1|3|3|cell-rborder|0ln>|<table|<row|<cell|1>|<cell|>|<cell|N
      ...
      node with value>>>>>|<tformat|<cwith|1|-1|1|1|cell-halign|l>|<cwith|1|-1|1|1|cell-lborder|0ln>|<cwith|1|-1|2|2|cell-halign|l>|<cwith|1|-1|3|3|cell-halign|l>|<cwith|1|-1|3|3|cell-rborder|0ln>|<table|<row|<cell|1>|<cell|>|<cell|N
  ...
  <\definition>
    ...
    <\itemize>
      ...
      <\equation*>
        <tabular*|<tformat|<cwith|1|-1|1|1|cell-halign|l>|<cwith|1|-1|1|1|cell-lborder|0ln>|<cwith|1|-1|1|1|cell-rborder|0ln>|<table|<row|<cell|<text|Enc<rsub|Node>(N)>\<assign\>>>|<row|<cell|<version-both|\<nobracket\>NodePrefix<around|(|N|)>|\<nobracket\>Enc<rsub|len><around*|(|N|)>><around|\|||\|><version-both|<version-suppressed>|Enc<rsub|HE><around|(|pk<rsub|N>|)><around*|\|||\|>>Enc<rsub|LE><around*|(|*ChildrenBitmap<around|(|N|)>|)>\<\|\|\>Enc<rsub|SC><around|(|v|)><around|\|||\|>*>>|<row|<cell|Enc<rsub|SC><around*|(|H<around|(|N<rsub|C<rsub|1>>|)>|)>*\<ldots\>*Enc<rsub|SC><around*|(|H<around|(|N<rsub|C<rsub|n>>|)>|)>>>>>>
      </equation*>
    </itemize>
  </definition>
  ...
  <\itemize>
    ...
    <item><math|ChildrenBitmap(N)\<assign\><around*|(|b<rsub|15>b<rsub|<version-both|15|14>><version-both|\<ldots\>b|\<ldots\>,b<rsub|1>,b><rsub|0>|)><rsub|2>>
  ...
  <\definition>
    ...
    <\equation*>
      <tabular|<tformat|<table|<row|<cell|BigKeySize<around*|(|T|)>>|<cell|:>|<cell|<around*|{|<version-both|Leaf,Extension|Leaf,Branch>|}>>|<cell|\<rightarrow\>>|<cell|\<bbb-N\>>>|<row|<cell|>|<cell|>|<cell|T>|<cell|\<mapsto\>>|<cell|<around*|{|<tabular|<tformat|<table|<row|<cell|126>|<cell|T=Leaf>>|<row|<cell|125>|<cell|<version-both|T=Extension|T=Branch>>>>>>|\<nobracket\>>>>>>>
    </equation*>
  </definition>
